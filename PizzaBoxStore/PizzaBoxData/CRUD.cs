...
namespace PizzaBoxData
{
    public class CRUD
    {
        ...
        public List<User> Getusers(Location l)
        {
            return DBSingle.Instance.dbInstance.User.Where<User>(u => u.LocationId == l.Id).ToList();
        }

        public List<Inventory> GetInventory(Location l)
        {
            return DBSingle.Instance.dbInstance.Inventory.Where<Inventory>(i => i.LocationId == l.Id).ToList();
        }

        public List<Order> GetActiveOrders(Location l)
        {

            return DBSingle.Instance.dbInstance.Order.Where<Order>(o => o.LocationId == l.Id && o.OrderStatus < 4).ToList();
        }

        public List<Order> GetAllOrders(Location l)
        {
            return DBSingle.Instance.dbInstance.Order.Where<Order>(o => o.LocationId == l.Id && o.OrderStatus != 5).ToList();
        }
        ...
        {
            DBSingle.Instance.dbInstance.Order.Update(o);
            DBSingle.Instance.dbInstance.SaveChanges();
        }
